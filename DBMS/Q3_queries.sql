...
SELECT UNIQUE customer_name FROM borrower;
...
SELECT * FROM employee WHERE salary > 1400 AND branch_name NOT LIKE "%Mumbai";

-- *j. Calculate the average salary of all employees and show the average salary as “avg_salary”. 
SELECT AVERAGE(salary) AS avg_salary FROM employee;
