# data = [
     ...
     # ["Deal", "Vernal", "Ironwood", "Wauwatosa", "Crewkerne", "Hialeah", "Norwich", "Dubbo", "Melton Mowbray", "Nags Head", "Keynsham", "Gallipolis", "Inverell", "Potsdam", "Lorain", "Dalby", "Millburn", "Monett", "Price", "Cocoa Beach"],
